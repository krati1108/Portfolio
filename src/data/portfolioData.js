...
export const experienceList = [
  {
    ...
    highlights: [
      ...
      "Partnered directly with key repeat accounts, including Coca-Cola, writing custom SQL queries to pull and transform data into tailored Power BI (DAX, Power Query/M) dashboards that improved reporting transparency and strengthened client retention",
      ...
      "Delivered a dual-track BI architecture, building internal Incorta dashboards for real-time operational visibility while engineering SQL-driven Power BI dashboards for external, customer-facing reporting",
    ],

...
import heroImage from '../assets/krati/krati-hero.png';
...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-10 bg-gradient-to-r from-black/55 via-black/15 to-black/10 pointer-events-none" />
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            {heroContent.greeting} <br /> <span className="text-white [-webkit-text-stroke:1px_#000000] [paint-order:stroke_fill]">{heroContent.titleHighlight}</span>
          </h1>
        ...
        <div 
          ...
          onClick={toggleVideo}
        >
          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full border border-white/30 bg-black/20 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#0274A1] transition-all duration-500 shadow-[0_0_30px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_40px_rgba(2,116,161,0.6)]">
            {!isPlaying ? (
              // Play Icon

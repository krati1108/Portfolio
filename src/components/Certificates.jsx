    ...
    <section id="certificates" className="bg-[#087F8C] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-12">
          ...
          {certificates.featured.length === 0 && (
            <div className="sm:col-span-2 lg:col-span-3 bg-black/80 border border-white/15 rounded-3xl p-10 text-center text-white/80 font-semibold">
              Certificate details will be published here once the certificate document is available.
            </div>
          )}
        </div>

        {/* View All Certificates CTA */}
        {certificates.documentUrl && <div data-aos="fade-up" data-aos-delay="700" className="flex justify-center">
          <a
